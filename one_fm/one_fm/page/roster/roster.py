...
def edit_post(posts, values):
    ...
    if args.post_status == "Plan Post":
        ...
        frappe.enqueue(plan_post, posts=posts, args=args, is_async=True, queue='long', at_front=True, timeout=3000)
        ...
        frappe.enqueue(cancel_post,posts=posts, args=args, is_async=True, queue='long', at_front=True, timeout=3000)
        ...
        frappe.enqueue(suspend_post, posts=posts, args=args, is_async=True, queue='long', at_front=True, timeout=3000)
        ...
        frappe.enqueue(post_off, posts=posts, args=args, is_async=True, queue='long', at_front=True, timeout=3000)

    frappe.enqueue(update_roster, key="staff_view", is_async=True, queue='long', timeout=3000)
