...
def get_current_user_details():
	...
	user_employee = frappe.get_value("Employee", {"user_id": user}, ["name", "employee_id", "employee_name", "image", "enrolled", "designation", "custom_enable_face_recognition","shift_working"], as_dict=1)
