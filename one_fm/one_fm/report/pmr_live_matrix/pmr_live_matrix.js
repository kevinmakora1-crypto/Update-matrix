frappe.query_reports["PMR Live Matrix"] = {
	...
	"onload": function(report) {
		...
		if (!document.getElementById('pmr-matrix-styles')) {
			$("<style>").prop("type", "text/css").prop("id", "pmr-matrix-styles").html(`
				/* Force aggressive fluid full width container by overriding Frappe root logic */
				#page-query-report .container, 
				#page-query-report .page-container, 
				...
				#page-query-report .frappe-control.input-max-width {
					max-width: 100% !important;
				}
				#page-query-report .frappe-datatable .dt-header .dt-cell--header {
				...
				#page-query-report .frappe-datatable .dt-cell {
					padding: 4px 6px !important;
					white-space: normal !important;
					word-wrap: break-word !important;
				...
				#page-query-report .report-summary {
				...
				#page-query-report .report-summary .summary-item {
					flex: none !important;
				...
				#page-query-report .report-summary .summary-item .summary-value {
				...
				#page-query-report .report-summary .summary-item .summary-label {
					font-size: 11.5px !important;
