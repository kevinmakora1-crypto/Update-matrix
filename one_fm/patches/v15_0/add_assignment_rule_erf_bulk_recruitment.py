...
def execute():
    process_task = create_process_task(
        ...
        task_description="Assigning Mr Pawan upon selection of Bulk Recruitment in the Hiring Method field of ERF doctype.",
        employee="HR-EMP-03806",
        process_owner=None,
        business_analyst=None,
        task_type="Repetitive",
        is_routine_task=0
    )
    assignment_rule_data = get_assignment_rule_json_file("erf_bulk_recruitment.json")
    if process_task:
