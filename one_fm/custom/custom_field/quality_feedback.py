def get_quality_feedback_custom_fields():
	return {
		"Quality Feedback": [
			...
			{
				"fieldname": "feedback_schedule_stage",
				"fieldtype": "Link",
			...
			{
				"fieldname": "quality_score_percentage",
				"fieldtype": "Float",
